import { a2 as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React, U as jsxRuntimeExports } from "./server-Pe6FDPZq.js";
import { u as useNavigate, a as useQueryClient, L as Link } from "./router-CtroGWBM.js";
import { u as useServerFn } from "./createSsrRpc-BtM581fZ.js";
import { u as useQuery } from "./useQuery-KqhF9Yc4.js";
import { c as clsx, u as useAuth, H as Header } from "./Header-CaPTonEp.js";
import { l as listHistory, d as deleteSession } from "./interview.functions-Drs3qsPL.js";
...
function HistoryPage() {
  ...
  const chartData = reactExports.useMemo(() => {
    ...
    return [...q.data.sessions].filter((s2) => s2.overall_score != null).reverse().map((s2, i) => ({
      name: `#${i + 1}`,
      score: Number(s2.overall_score),
      topic: s2.topic
    }));
  }, [q.data]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-6xl px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Your history" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-muted-foreground", children: "Track your performance over time." }),
      chartData.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-xl border border-border bg-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground", children: "Score trend" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "oklch(0.32 0.03 260)", strokeDasharray: "3 3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "name", stroke: "oklch(0.72 0.03 255)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { domain: [0, 10], stroke: "oklch(0.72 0.03 255)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
            background: "oklch(0.22 0.035 260)",
            border: "1px solid oklch(0.32 0.03 260)",
            borderRadius: 8
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "score", stroke: "oklch(0.62 0.19 275)", strokeWidth: 2, dot: {
            r: 4
          } })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 overflow-hidden rounded-xl border border-border", children: q.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center text-muted-foreground", children: "Loading…" }) : !q.data?.sessions.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 text-center text-muted-foreground", children: [
        "No interviews yet. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard", className: "text-primary hover:underline", children: "Start one" }),
        "."
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-card text-left text-xs uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5", children: "Topic" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5", children: "Difficulty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5", children: "Questions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5", children: "Score" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", {})
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: q.data.sessions.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border bg-background/50 hover:bg-card/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: new Date(s2.started_at).toLocaleString() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground", children: s2.topic }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: s2.difficulty }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-muted-foreground", children: [
            s2.total_questions,
            "/",
            s2.max_questions
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: s2.overall_score != null ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", style: {
            color: scoreColor(Number(s2.overall_score))
          }, children: s2.overall_score }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "incomplete" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-3", children: [
            ...
            }, className: "text-destructive hover:underline", children: "Delete" })
          ] }) })
        ] }, s2.id)) })
      ] }) })
    ] })
