import { a6 as requireReact, r as reactExports, U as jsxRuntimeExports, a7 as React, T as React$1 } from "./server-Pe6FDPZq.js";
import { m as reactDomExports, R as ReactDOM, u as useNavigate, L as Link } from "./router-CtroGWBM.js";
import { a as getStoredUser, o as onAuthChange, c as clearSession } from "./auth-client-nNZcxKNv.js";
var shim = { exports: {} };
...
const Brain = createLucideIcon("brain", __iconNode$6);
...
function Header({ authed }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-border bg-background/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 text-lg font-bold text-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "text-primary", size: 22 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "InterviewAI" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-2 text-sm", children: authed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard", className: "rounded-md px-3 py-1.5 text-muted-foreground hover:text-foreground", children: "Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/history", className: "rounded-md px-3 py-1.5 text-muted-foreground hover:text-foreground", children: "History" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "inline-flex items-center rounded-full p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { children: initials }) }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-1 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { className: "text-sm font-medium", children: user?.name ?? user?.email }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onSelect: () => navigate({ to: "/profile" }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "mr-2 inline-block", size: 14 }),
            " Profile"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onSelect: () => navigate({ to: "/settings" }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "mr-2 inline-block", size: 14 }),
            " Settings"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onSelect: () => {
            clearSession();
            navigate({ to: "/" });
          }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "mr-2 inline-block", size: 14 }),
            " Sign out"
          ] })
        ] })
      ] }) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "rounded-md px-3 py-1.5 text-muted-foreground hover:text-foreground", children: "Sign in" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "rounded-md bg-primary px-4 py-1.5 font-medium text-primary-foreground hover:opacity-90", children: "Get started" })
    ] }) })
  ] }) });
}
export {
